...
class Cell:
    ...
    def __init__(self, birthtime, mu, **kwargs):
        ...
        else: self.pg3pr = np.random.randint(0,5)
        
        if 'ppar' in kwargs: self.ppar = kwargs['ppar']
        else: self.ppar = np.random.randint(0,5)
    ...
    @classmethod  
    def clone(cls, b,g3p,md,mk,mr,d,k,r,gly,g3pr):
        return cls(birthtime=b.tnow, mu=b.mu, volume=1, nextdiv=b.tnow+np.random.randint(b.mu-sigma,b.mu+sigma),
                   pinpd = 1, pinpk = 1, pactpd = 0, pactpk = 0, ppr=0,
                   pg3p=g3p, pmd=md,pmk=mk,pmr=mr,pd=d,pk=k,pr=r, pgly=gly, pg3pr=g3pr, ppar=1,
                   xpos = b.xpos,
                   ypos = b.ypos,
    ...
    def proliferate(self):
        ...
        nl=[Cell.clone(self,g3p1,md1, mk1, mr1, d1, k1, r1, gly1,g3pr1),
            Cell.clone(self,g3p-g3p1,md-md1,mk-mk1,mr-mr1,d-d1,k-k1,r-r1, gly-gly1,g3pr-g3pr1)]
    ...
    def ssa(self):
        model = gp.Gillespie(self.pinpd,self.pinpk,self.pactpd,
                                   ...
                                   self.pd, self.pk, self.pr, self.pgly, self.pg3pr, self.ppar)
