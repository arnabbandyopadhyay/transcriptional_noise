...
class Gillespie_bistable(Model):
     def __init__(self, ppd, ppd_r, ppt, ppt_r,
                  ppr, pg3p, pmd, pmr, pmt, pd, pr, pt, 
            ...
            """
            scaling=1e9
            rate1 = Parameter(name="kon_pdr", expression=2165.44314226246/scaling)
            rate2 = Parameter(name="koff_pdr", expression=10014.7094615103/scaling)
            rate3 = Parameter(name="kon_ptr", expression=1588.06318455853/scaling)
            rate4 = Parameter(name="koff_ptr", expression=10477.3841801672/scaling)
            rate5 = Parameter(name="ktrsc1", expression=0.5)
            rate6 = Parameter(name="ktrsc2", expression=0.5)
            rate7 = Parameter(name="ktrsc3", expression=0.5/2)
            rate8 = Parameter(name="ktrsl1", expression=0.3)
            rate9 = Parameter(name="ktrsl2", expression=0.3)
            rate10 = Parameter(name="ktrsl3", expression=0.3)
            rate11 = Parameter(name="ktrsp_g3p", expression=0)#0.01757360326999)
            rate12 = Parameter(name="kon_g3pr", expression=99.7805018542808/scaling)           
            rate13 = Parameter(name="kon_g3pd", expression=0.103423441900033)
            ...
            rate20 = Parameter(name="dg3p", expression=0.035)
...
#     # model = Gillespie_bistable(1,0,1,0,1,5,5,5,5,5,5,5)
